...
MODEL_MAP = {
    "CN": "Helsinki-NLP/opus-mt-zh-en",  # CHINESE (SIMPLIFIED -- TRADITIONAL) TO ENGLISH TRANSLATION
    "JP": "Helsinki-NLP/opus-mt-ja-en",  # JAPANESE TO ENGLISH TRANSLATION
    "KR": "Helsinki-NLP/opus-mt-ko-en",  # KOREAN TO ENGLISH TRANSLATION
}
